...
create index auditoriums_price_dramas_id_idx on auditoriums_price(dramas_id);

create index auditoriums_price_auditoriums_id_idx on auditoriums_price(auditoriums_id);
